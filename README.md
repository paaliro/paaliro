...
<h1 style="font-size: 48px; font-weight: bold; color: #1a202c; margin-bottom: 20px;">
  :man_technologist: About Me
</h1>
<p style="font-size: 18px; line-height: 1.6; color: #2d3748;">
...
<h2>💼 Current Role</h2>
<p>🔧 Working on production-level frontend projects with real-world impact.</p>


<h2> 🚀 Goals</h2>
<ul>
    <li>Level up to Full-Stack Development</li>
    <li>Build and launch my own side projects</li>
